...
void ImDrawList::AddConcavePolyFilled(const ImVec2* points, const int points_count, ImU32 col, bool anti_aliased)
{
    ...
    if (anti_aliased)
    {
        ...
        ImVec2* scratch_buffer = (ImVec2*)alloca((sizeof(ImTriangulatorNode) * points_count + sizeof(ImTriangulatorNode*) * points_count * 2) + sizeof(ImVec2));
        triangulator.Init(points, points_count, scratch_buffer);
